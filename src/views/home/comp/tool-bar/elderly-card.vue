...
<template>
  <div class="wrapper">
    ...
    <watch v-if="otherPage == '3' || otherPage == '4' || otherPage == '5' " :timestamp="timestamp"
      :sta="otherPage" @goClick="receive" />
          ...
          <div class="container">
            ...
            <div class="footer">
              <p class="item">
                ...
                <span class="text">中国老龄协会老年人才信息中心</span>
              </p>
              <p class="item">
    ...
    <van-button size="large" v-if="otherPage === '1'" class="_m" round @click="showAction = true">
      证照管理3</van-button>
    <van-action-sheet v-model="showAction" :actions="maction" cancel-text="取消" description="证照管理"
      close-on-click-action @select="selItem" />
  </div>
